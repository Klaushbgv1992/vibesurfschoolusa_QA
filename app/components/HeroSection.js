      ...
      <div className="relative w-full h-[90vh] overflow-hidden">
        ...
        {slideImages.map((image, index) => (
          ...
          >
            <Image
              src={image}
              alt={`Vibe Guesthouse Slide ${index + 1}`}
              fill
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-10 px-4">
          <div className="text-center animate-fadeIn">
            ...
            <a
              ...
              className="inline-block bg-amber-400 hover:bg-amber-500 text-gray-900 px-8 py-4 rounded-sm text-lg font-semibold transition-colors shadow-md"
              target="_blank"
          ...
          {slideImages.map((_, index) => (
            <button
              ...
              className={`w-3 h-3 rounded-full transition-colors ${
                index === currentSlide ? 'bg-amber-400' : 'bg-white/60 hover:bg-white'
              }`}
      ...
      <div className="bg-white py-12 border-b border-gray-100">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-12">
            ...
            <a
              href="https://www.airbnb.com/rooms/1185679450503007200?source_impression_id=p3_1742350524_P3ntnWSMNQoPAbvn"
              className="inline-block bg-amber-500 hover:bg-amber-600 text-white font-medium py-3 px-8 rounded-sm transition-colors shadow-sm"
              target="_blank"
              rel="noopener noreferrer"
            >
              Book Your Stay
